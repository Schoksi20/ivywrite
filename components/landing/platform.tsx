...
const tabs = [
  {
    icon: (
      <svg viewBox="0 0 32 32" fill="none"><rect x="4" y="4" width="24" height="24" rx="4" stroke="var(--accent)" strokeWidth="1.8" /><path d="M9 11h14M9 16h10M9 21h7" stroke="var(--accent)" strokeWidth="1.8" strokeLinecap="round" /></svg>
    ),
  ...
  {
    icon: (
      <svg viewBox="0 0 32 32" fill="none"><circle cx="16" cy="10" r="5" stroke="var(--accent)" strokeWidth="1.8" /><path d="M6 26c0-5.5 4.5-10 10-10s10 4.5 10 10" stroke="var(--accent)" strokeWidth="1.8" strokeLinecap="round" /><path d="M22 8l2 2-6 6" stroke="var(--accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>
    ),
  ...
  {
    icon: (
      <svg viewBox="0 0 32 32" fill="none"><path d="M22 4H10a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z" stroke="var(--accent)" strokeWidth="1.8" /><path d="M19 4v4H13V4M12 16l3 3 5-5" stroke="var(--accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>
    ),
        ...
        <AnimatedSection className="mt-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {tabs.map((tab, i) => (
              ...
              >
                <div className="w-10 h-10 mb-4">{tab.icon}</div>
                <div className="text-sm font-bold text-heading mb-2">{tab.title}</div>
                <div className="text-xs text-body leading-relaxed">{tab.desc}</div>
              </button>
            ))}
          </div>
        </AnimatedSection>
