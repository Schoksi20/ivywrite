...
const writers = [
  { init: "A", name: "A. Sharma", school: "Harvard University", prog: "MS Computer Science. Specializes in STEM and research SOPs.", ct: "200+ SOPs delivered" },
  { init: "P", name: "P. Nair", school: "Yale University", prog: "MBA. Focuses on business school and management programs.", ct: "180+ SOPs delivered" },
  { init: "R", name: "R. Mehta", school: "MIT", prog: "PhD Electrical Engineering. STEM research specialist.", ct: "310+ SOPs delivered" },
  { init: "S", name: "S. Kapoor", school: "Princeton University", prog: "MA Public Policy. Policy, law, and social sciences focus.", ct: "140+ SOPs delivered" },
  { init: "K", name: "K. Iyer", school: "Stanford University", prog: "MS Data Science. Analytics, AI, and tech programs.", ct: "220+ SOPs delivered" },
  { init: "N", name: "N. Bose", school: "Columbia University", prog: "MFA Creative Writing. Humanities and arts programs.", ct: "95+ SOPs delivered" },
  { init: "V", name: "V. Singh", school: "Booth (U Chicago)", prog: "MBA. Finance, consulting, and leadership programs.", ct: "160+ SOPs delivered" },
  { init: "D", name: "D. Menon", school: "Johns Hopkins", prog: "MS Public Health. Medical and health science programs.", ct: "130+ SOPs delivered" },
];
